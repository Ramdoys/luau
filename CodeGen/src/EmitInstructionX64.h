...
void emitInstCall(IrRegAllocX64& regs, ModuleHelpers& helpers, int ra, int nparams, int nresults);
...
void emitInstForGLoop(IrRegAllocX64& regs, int ra, int aux, Label& loopRepeat);
